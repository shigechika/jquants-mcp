...
| **Light** | リアルタイム日次株価、分足（tick アドオン）、投資部門別売買、TOPIX 四本値、バルクダウンロード |
| **Standard** | 信用取引残高 / 増担保規制、空売り比率、空売り残高報告、指数四本値、日経225オプション |
| **Premium** | 詳細財務（BS/PL/CF）、配当、先物・オプション四本値、前場のみのデータ、売買内訳 |
...
キャッシュを自動的に無効化します。`get_candlestick_data` の調整済み価格、
