...
release-please を導入する前（〜2026-04-18、v0.3.0 リリース時点）の手動管理エントリ。
本ファイルは記録保持用のため追記しない。現行の変更履歴は [CHANGELOG.md](../CHANGELOG.md) および [GitHub Releases](https://github.com/shigechika/jquants-mcp/releases) を参照。
